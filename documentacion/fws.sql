...
CREATE TABLE IF NOT EXISTS `det_rec_proy` (
  ...
  KEY `ID_PROYECT_idx` (`ID_PROYECT`),
  KEY `ID_RECU_idx` (`ID_RECURSO`),
  KEY `ID_TAREA_idx` (`ID_TAREA`),
  CONSTRAINT `ID_PROYECT` FOREIGN KEY (`ID_PROYECT`) REFERENCES `proyecto` (`ID_PROYECT`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `proyecto` (
  ...
  CONSTRAINT `FK_OT` FOREIGN KEY (`ID_OT`) REFERENCES `orden_trabajo` (`ID_OT`) ON DELETE NO ACTION ON UPDATE NO ACTION,
